...
INITIALIZATION
  ...
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'calculateThumbnail'      ,@requireGui,ak_variadic);
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'closeImage'              ,@requireGui,ak_variadic);
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'displayImage'            ,@requireGui,ak_variadic);
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'executeWorkflow'         ,@requireGui,ak_variadic);
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'getScreenSize'           ,@requireGui,ak_variadic);
  ...
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'resizeImage'             ,@requireGui,ak_variadic);
  builtinFunctionMap.registerRule(IMIG_NAMESPACE,'saveImage'               ,@requireGui,ak_variadic);
