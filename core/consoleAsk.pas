...
FUNCTION ask_impl intFuncSignature;
  ...
  begin
    ...
    then result:=literalRecycler.newStringLiteral(ask(str0^.value,context.messages))
      ...
      try
        ...
        result:=literalRecycler.newStringLiteral(ask(str0^.value, opt,context.messages));
      finally
