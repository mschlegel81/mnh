...
INITIALIZATION
  ...
  builtinFunctionMap.registerRule(SYSTEM_BUILTIN_NAMESPACE,'serialize'    ,@serialize_impl   ,ak_variadic_1  {$ifdef fullVersion},'serialize(x);//Returns a string representing x.#serialize(x,deflate:Boolean,reuse:Boolean);//Custom serialization.'{$endif});
