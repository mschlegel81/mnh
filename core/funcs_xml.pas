...
INITIALIZATION
  registerRule(FILES_BUILTIN_NAMESPACE,'readXmlFile',@readXmlFile_impl,ak_unary{$ifdef fullVersion},'readXmlFile(filename:String);//Reads contents of an XML file and returns the contents as a list'{$endif},[se_readFile]);
