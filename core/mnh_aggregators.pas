...
TYPE
  ...
  public
    ...
    PROCEDURE addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context); virtual; abstract;
  ...
  T_listAggregator=object(T_aggregator)
    CONSTRUCTOR create;
    PROCEDURE addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context); virtual;
  end;
...
PROCEDURE T_listAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
    P_listLiteral(resultLiteral)^.append(er.literal,not(doDispose));
  end;

PROCEDURE T_setAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
    P_setLiteral(resultLiteral)^.append(er.literal,not(doDispose));
  end;

PROCEDURE T_concatAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_concatAltAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_headAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_trailingAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_minAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_maxAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_stringConcatAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  ...
  begin
    ...
    if er.literal^.literalType<>lt_void then begin
      if (resultLiteral^.literalType=lt_string) and (er.literal^.literalType in C_scalarTypes) then begin
        ...
        newResult:=operator_StrConcat(param,location,P_context(context)^);
...
PROCEDURE T_andAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
...
PROCEDURE T_orAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  begin
    aggregationDefaultHandling;
    if er.literal^.literalType=lt_boolean then begin
...
PROCEDURE T_opAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
  VAR newResult:P_literal;
      param:P_listLiteral;
  begin
    aggregationDefaultHandling;
    ...
    then resultLiteral:=er.literal^.rereferenced
      ...
      param:=P_listLiteral(newListLiteral(2)^.append(resultLiteral,true)^.append(er.literal,true));
      newResult:=opPointer(param,location,P_context(context)^);
      disposeLiteral(param);
      disposeLiteral(resultLiteral);
      resultLiteral:=newResult;
    end;
...
PROCEDURE T_expressionAggregator.addToAggregation(er:T_evaluationResult; CONST doDispose:boolean; CONST location:T_tokenLocation; CONST context:P_context);
