...
CONST
  STACK_DEPTH_LIMIT={$ifdef Windows}11000{$else}{$ifdef debugMode}2000{$else}4100{$endif}{$endif};
  {$i code_hash.inc}
  {$i build_number.inc}
...
{tt_pow2}                       (defaultHtmlSpan:'operator';   reservedWordClass:rwc_specialConstruct; helpText:'Pseudo-Operator: shorthand for ^2'; helpLink:''),
{tt_pow3}                       (defaultHtmlSpan:'operator';   reservedWordClass:rwc_specialConstruct; helpText:'Pseudo-Operator: shorthand for ^3'; helpLink:''),
