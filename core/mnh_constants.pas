...
CONST
  ...
  C_tokenInfo:array[T_tokenType] of record
                                 defaultId:string;          defaultHtmlSpan:string; reservedWordClass:T_reservedWordClass;  helpText,helpLink:string; end=(
{tt_literal}                    (defaultId:'';              defaultHtmlSpan:'literal';    reservedWordClass:rwc_not_reserved;     helpText:'A literal'; helpLink:''),
{tt_aggregatorExpressionLiteral}(defaultId:'';              defaultHtmlSpan:'literal';    reservedWordClass:rwc_not_reserved;     helpText:'An aggregator expression literal'; helpLink:''),
{tt_identifier}                 (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'An identifier (unresolved)'; helpLink:''),
{tt_parameterIdentifier}        (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'A parameter identifier'; helpLink:'/types.html#expressions'),
{tt_localUserRule}              (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'A local user rule'; helpLink:'/functions.html#declarations'),
{tt_importedUserRule}           (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'An imported user rule'; helpLink:'/functions.html#declarations'),
{tt_intrinsicRule}              (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_not_reserved;     helpText:'A built in rule'; helpLink:''),
{tt_rulePutCacheValue}          (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_not_reserved;     helpText:'A put-cache-value call'; helpLink:''),
{tt_customTypeRule}             (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'A custom type rule'; helpLink:'/functions.html#typeMod'),
{tt_blockLocalVariable}         (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'A block-local variable'; helpLink:'/functions.html#localMod'),
{tt_eachParameter}              (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'each parameter'; helpLink:'/specials.html#each'),
{tt_eachIndex}                  (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'each index'; helpLink:'/specials.html#each'),
{tt_ponFlipper}                 (defaultId:'.';             defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'A pseudo-object-notation flipper'; helpLink:'/functions.html#calls'),
{tt_aggregatorConstructor}      (defaultId:'aggregator';    defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: aggregator#The aggregator constructor'; helpLink:'/specials.html#aggregator'),
...
{tt_agg}                        (defaultId:'.agg';          defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: agg#Used for list aggregation#Syntax: <input>.agg(<aggregator>) - where <aggregator> may be an expression or a simple operator as +'; helpLink:'/specials.html#aggregation'),
{tt_while}                      (defaultId:'while';         defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: while#Used for loops#Syntax: while(<entry condition>,<body>) - where <entry condition> must return a scalar boolean'; helpLink:'/specials.html#while'),
{tt_beginBlock}                 (defaultId:'begin';         defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: begin#Opening delimiter for procedural blocks'; helpLink:'/functions.html#beginEnd'),
{tt_beginRule}                  (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:''; helpLink:''), {No default ID, because tokenizer shall not produce this token}
{tt_beginExpression}            (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:''; helpLink:''), {No default ID, because tokenizer shall not produce this token}
{tt_endBlock}                   (defaultId:'end';           defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: end#Closing delimiter for procedural blocks'; helpLink:'/functions.html#beginEnd'),
{tt_endRule}                    (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:''; helpLink:''), {No default ID, because tokenizer shall not produce this token}
{tt_endExpression}              (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:''; helpLink:''), {No default ID, because tokenizer shall not produce this token}
{tt_save}                       (defaultId:'save';          defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: save#Saves the current value store for future function calls'; helpLink:'/functions.html#beginSaveEnd'),
{tt_return}                     (defaultId:'return';        defaultHtmlSpan:'builtin';    reservedWordClass:rwc_specialConstruct; helpText:'Special construct: return#Returns from the current function with the given result value'; helpLink:''),
{tt_pseudoFuncPointer}          (defaultId:'::';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_specialConstruct; helpText:'Special construct: ::# Returns reference to a function#::f -> {f@$params}'; helpLink:'/operators.html#funcToExp'),
{tt_braceOpen}                  (defaultId:'(';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Opening round bracket#Used as in default mathematical syntax.'; helpLink:''),
{tt_braceClose}                 (defaultId:')';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Closing round bracket#Used as in default mathematical syntax.'; helpLink:''),
{tt_parList_constructor}        (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'A parameter list constructor'; helpLink:''),
{tt_parList}                    (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'A parameter list'; helpLink:''),
{tt_listBraceOpen}              (defaultId:'[';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Square opening bracket#Used for list construction and list access'; helpLink:'/types.html#lists'),
{tt_listBraceClose}             (defaultId:']';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Square closing bracket#Used for list construction and list access'; helpLink:'/types.html#lists'),
{tt_list_constructor}           (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'A list constructor'; helpLink:'/types.html#lists'),
{tt_list_Constructor_ranging}   (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'A list constructor'; helpLink:'/types.html#lists'),
{tt_expBraceOpen}               (defaultId:'{';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Curly opening bracket#Delimits an expression'; helpLink:'/types.html#expressions'),
{tt_expBraceClose}              (defaultId:'}';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Curly closing bracket#Delimits an expression'; helpLink:'/types.html#expressions'),
{tt_iifCheck}                   (defaultId:'?';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Inline-if-operator'; helpLink:'/operators.html#iifOps'),
{tt_iifElse}                    (defaultId:':';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Inline-if-operator'; helpLink:'/operators.html#iifOps'),
{tt_separatorComma}             (defaultId:',';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Separator comma'; helpLink:''),
{tt_separatorCnt}               (defaultId:'..';            defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Separator ..#Used for constructing ranges and only allowed in that context'; helpLink:''),
{tt_separatorMapItem}           (defaultId:'=>';            defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Separator =>#Used for constructing key-value-pairs'; helpLink:''),
{tt_comparatorEq}               (defaultId:'=';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Equals operator#Returns true if the scalar comparands are type-compatible#and equal#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorNeq}              (defaultId:'<>';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Not-equals operator#Returns true if the scalar comparands are type-compatible#and not equal#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorLeq}              (defaultId:'<=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Lesser-or-equals operator#Returns true if the scalar comparands are type-compatible#and the left hand side is lesser or equal to the right hand side#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorGeq}              (defaultId:'>=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Greater-or-equals operator#Returns true if the scalar comparands are type-compatible#and the left hand side is greater or equal to the right hand side#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorLss}              (defaultId:'<';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Lesser operator#Returns true if the scalar comparands are type-compatible#and the left hand side is lesser than the right hand side#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorGrt}              (defaultId:'>';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Greater operator#Returns true if the scalar comparands are type-compatible#and the left hand side is greater than the right hand side#For list operands a list of booleans is returned'; helpLink:'/operators.html#compOps'),
{tt_comparatorListEq}           (defaultId:'==';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Strict-equals operator#Returns true if the comparands are strictly equal.#Always returns a scalar boolean'; helpLink:'/operators.html#compOps'),
{tt_operatorIn}                 (defaultId:'in';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'In operator#Applies to all literals on the left hand side and lists on the right hand side.#Returns true if the RHS contains the LHS'; helpLink:'/operators.html#listOps'),
{tt_operatorAnd}                (defaultId:'and';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Bit-wise and operator#Applies to (lists of) integers and (lists of) booleans'; helpLink:'/operators.html#logOps'),
{tt_operatorOr}                 (defaultId:'or';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Bit-wise or operator#Applies to (lists of) integers and (lists of) booleans'; helpLink:'/operators.html#logOps'),
{tt_operatorXor}                (defaultId:'xor';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Bit-wise xor operator#Applies to (lists of) integers and (lists of) booleans'; helpLink:'/operators.html#logOps'),
{tt_operatorLazyAnd}            (defaultId:'AND';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Lazy and operator#Applies to scalar booleans only'; helpLink:'/operators.html#logOps'),
{tt_operatorLazyOr}             (defaultId:'OR';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Lazy or operator#Applies to scalar booleans only'; helpLink:'/operators.html#logOps'),
{tt_operatorPlus}               (defaultId:'+';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Plus operator#Applies to (lists of) numbers and (lists of) strings'; helpLink:'/operators.html#arithOps'),
{tt_operatorMinus}              (defaultId:'-';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Minus operator#Applies to (lists of) numbers'; helpLink:'/operators.html#arithOps'),
{tt_operatorMult}               (defaultId:'*';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Multiplication operator#Applies to (lists of) numbers'; helpLink:'/operators.html#arithOps'),
{tt_operatorDivReal}            (defaultId:'/';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Division operator#Applies to (lists of) numbers'; helpLink:'/operators.html#arithOps'),
{tt_operatorDivInt}             (defaultId:'div';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Integer division operator#Applies to (lists of) integers'; helpLink:'/operators.html#arithOps'),
{tt_operatorMod}                (defaultId:'mod';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Integer modulo operator#Applies to (lists of) integers'; helpLink:'/operators.html#arithOps'),
{tt_operatorPot}                (defaultId:'^';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Potentiation operator#Applies to (lists of) numbers'; helpLink:'/operators.html#arithOps'),
{tt_operatorStrConcat}          (defaultId:'&';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'String concatenation operator#Applies to all literals'; helpLink:'/operators.html#stringOps'),
{tt_operatorOrElse}             (defaultId:'orElse';        defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Or-Else operator#Employed to provide a fallback to void literals'; helpLink:'/operators.html#orElseOp'),
{tt_operatorConcat}             (defaultId:'|';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'List concatenation operator#Applies to all literals'; helpLink:'/operators.html#listOps'),
{tt_operatorConcatAlt}          (defaultId:'||';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'List concatenation operator#Applies to all literals'; helpLink:'/operators.html#listOps'),
{tt_unaryOpNegate}              (defaultId:'!';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Logical negation'; helpLink:'/operators.html#logOps'),
{tt_unaryOpPlus}                (defaultId:'+';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Unary plus operator#Neutral'; helpLink:'/operators.html#arithOps'),
{tt_unaryOpMinus}               (defaultId:'-';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Unary minus operator#Negates the operand'; helpLink:'/operators.html#arithOps'),
{tt_listToParameterList}        (defaultId:'@';             defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'List-to-parameter-list operator'; helpLink:'/operators.html#listOps'),
{tt_declare}                    (defaultId:'->';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Declaration operator'; helpLink:'/functions.html#declarations'),
{tt_assign}                     (defaultId:':=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Assignment operator'; helpLink:'/functions.html#assignments'),
{tt_mutate}                     (defaultId:':=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Mutate-assign operator'; helpLink:'/functions.html#assignments'),
{tt_assignNewBlockLocal}        (defaultId:':=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Assign new block local operator'; helpLink:'/functions.html#assignments'),
{tt_assignExistingBlockLocal}   (defaultId:':=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Assign existing block local operator'; helpLink:'/functions.html#assignments'),
{tt_mut_nested_assign}          (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignPlus}             (defaultId:'+=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Incrementation operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedPlus}             (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignMinus}            (defaultId:'-=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Decrementation operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedMinus}            (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignMult}             (defaultId:'*=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Multipliy/assign operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedMult}             (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignDiv}              (defaultId:'/=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Divide/assign operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedDiv}              (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignStrConcat}        (defaultId:'&=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'String-concatenate/assign operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedStrConcat}        (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignAppend}           (defaultId:'|=';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'List-concatenate/assign operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedAppend}           (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignAppendAlt}        (defaultId:'||=';           defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Alt-List-concatenate/assign operator'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedAppendAlt}        (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_mut_assignDrop}             (defaultId:'>>';            defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Drop operator. Drops element from a set (by value) or from a map (by key)'; helpLink:'/operators.html#cStyleOps'),
{tt_mut_nestedDrop}             (defaultId:'';              defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:''; helpLink:''),
{tt_type}                       (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_not_reserved;     helpText:'Type'; helpLink:'/functions.html#restrictions'),
{tt_typeCheck}                  (defaultId:'';              defaultHtmlSpan:'builtin';    reservedWordClass:rwc_not_reserved;     helpText:'Type check'; helpLink:'/functions.html#restrictions'),
{tt_customTypeCheck}            (defaultId:'';              defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'Custom type check'; helpLink:'/functions.html#restrictions'),
{tt_semicolon}                  (defaultId:';';             defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Semicolon#Ends a statement'; helpLink:''),
{tt_optionalParameters}         (defaultId:'...';           defaultHtmlSpan:'identifier'; reservedWordClass:rwc_not_reserved;     helpText:'Remaining arguments#Allowes access to anonymous furhter parameters#Returns a list'; helpLink:'/functions.html#variadic'),
{tt_modifier}                   (defaultId:'';              defaultHtmlSpan:'modifier';   reservedWordClass:rwc_modifier;         helpText:'Modifier'; helpLink:'/functions.html#modifiers'),
{tt_EOL}                        (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'End-Of-Input#Helper token; May also indicate a comment'; helpLink:''),
{tt_docComment}                 (defaultId:'';              defaultHtmlSpan:'comment';    reservedWordClass:rwc_not_reserved;     helpText:'Documentation comment'; helpLink:''),
{tt_attributeComment}           (defaultId:'';              defaultHtmlSpan:'comment';    reservedWordClass:rwc_not_reserved;     helpText:'Attribute comment'; helpLink:''),
{tt_use}                        (defaultId:'USE';           defaultHtmlSpan:'modifier';   reservedWordClass:rwc_modifier;         helpText:'Marker: USE#Denotes the use clause#Followed by package paths (as string) or package ids'; helpLink:'/packages.html#importing'),
{tt_include}                    (defaultId:'INCLUDE';       defaultHtmlSpan:'modifier';   reservedWordClass:rwc_modifier;         helpText:'Marker: INCLUDE#Denotes the include clause#Followed by one package path (as string) or one package id'; helpLink:'/packages.html#including'),
{tt_nameOf}                     (defaultId:'nameOf';        defaultHtmlSpan:'operator';   reservedWordClass:rwc_operator;         helpText:'Returns the name of the argument or the blank string if there is none'; helpLink:''),
{tt_blank}                      (defaultId:'';              defaultHtmlSpan:'';           reservedWordClass:rwc_not_reserved;     helpText:'Blank#Helper token; May indicate a comment or whitespace'; helpLink:''));
TYPE
  T_literalType = (
    lt_error,
