...
TYPE
  ...
  T_evaluationContext=object
    ...
    FUNCTION newToken(CONST location:T_tokenLocation; CONST tokenType:T_tokenType):P_token; inline;
    FUNCTION newLiteralToken(CONST location:T_tokenLocation; CONST literal:P_literal):P_token; inline;
...
FUNCTION T_evaluationContext.newToken(CONST location:T_tokenLocation; CONST tokenType:T_tokenType):P_token; inline;
  begin
...
FUNCTION T_evaluationContext.newLiteralToken(CONST location:T_tokenLocation; CONST literal:P_literal):P_token; inline;
  begin
    result:=newToken(location,tt_literal);
