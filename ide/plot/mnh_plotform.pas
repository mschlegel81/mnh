...
INITIALIZATION
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'plotClosed'       ,@plotClosedByUser_impl,ak_nullary,[se_readGuiState]);
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'clearAnimation'   ,@clearPlotAnim_impl   ,ak_variadic,[se_alterGuiState]);
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'addAnimationFrame',@addAnimFrame_impl    ,ak_nullary,[se_alterGuiState]);
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'display'          ,@display_imp          ,ak_nullary,[se_alterGuiState]);
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'postDisplay'      ,@postdisplay_imp      ,ak_nullary,[se_alterGuiState]);
  builtinFunctionMap.registerRule(PLOT_NAMESPACE,'plotImageSize'    ,@plotImageSize_imp    ,ak_nullary,[se_readGuiState]);
end.
