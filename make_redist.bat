...
@rem @echo ------------------------ building optimized binaries -------------------------------
@rem @%fpc% consoles\mnh_console.pas -obin\mnh_console.exe %optimize%  
@rem @%fpc% gui\mnh_gui.lpr -obin\mnh_gui.exe %optimize% -WG %guiOpt%
@rem @echo ------------------------------------------------------------------------------------
@rem @%delp%
@rem @del bin\*.lfm bin\*.res
