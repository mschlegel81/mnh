...
@%fpc% consoles\mnh_console.pas -obin\mnh_light.exe %optimize% %guiOpt% 
@%fpc% consoles\mnh_console.pas -obin\mnh_console.exe %optimize% %guiOpt% -dplots
...
@%fpc% consoles\mnh_console.pas -obin\mnh_light_debug.exe %debug% %guiOpt%
@%fpc% consoles\mnh_console.pas -obin\mnh_console_debug.exe %debug% %guiOpt% -dplots
